...
module.exports = {
    ...
    const reportEmbed = new EmbedBuilder()
      ...
      .addFields(
        {name: 'Message', value: ( interaction.targetMessage.content.length > 0 ? interaction.targetMessage.content : 'Embedded Content' ) },
        {name: 'Author', value: interaction.targetMessage.author.tag, inline: true},
        {name: 'Channel/Thread', value: `#${interaction.targetMessage.channel.name}`, inline: true},
        {name: 'Reported By', value: interaction.user.tag, inline: true},
        {name: 'Link', value: `[Go to Message](${interaction.targetMessage.url}) ➡`, inline: true}
      );
